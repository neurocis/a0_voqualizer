...
def test_canonical_html_has_prompt_clear_and_original_controls():
    ...
    for marker in (
        ...
        'w62-wyoming-runtime-autostart-2026-06-09-1',
    ):
...
def test_voqualizer_js_does_not_top_level_import_wyoming_client():
    ...
    assert "await import('/plugins/a0_voqualizer/webui/wyoming/wyoming-ws-client.js?v=w62-wyoming-runtime-autostart-2026-06-09-1')" in src
